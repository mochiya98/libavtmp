...
<html>
    <body>
        <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/@libav.js/variant-default@6.10.9/dist/libav-6.10.9.0-default.js"></script>
...
<html>
    <body>
        <script type="text/javascript" src="libav-6.10.9.0-default.js"></script>
        <script type="text/javascript">(async function() {
...
fragments. As of version 6.9.8.1, an empty build is approximately 178KiB
...
subtracting away the empty and library sizes). Note that the library columns
how dependencies: for example, the `decoder-libopus` fragment depends on the
...
The wrapper (“glue”) code is up to 408KiB, but is highly compressible.
